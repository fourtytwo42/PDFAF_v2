...
export const REMEDIATION_CRITERION_TOOL_MAP: Record<string, readonly string[]> = {
  ...
  heading_structure:    ['synthesize_basic_structure_from_layout', 'create_structure_from_degenerate_native_anchor', 'create_heading_from_visible_text_anchor', 'create_heading_from_ocr_page_shell_anchor', 'create_heading_from_candidate', 'normalize_heading_hierarchy', 'artifact_repeating_page_furniture'],
  ...
  reading_order:        ['synthesize_basic_structure_from_layout', 'create_structure_from_degenerate_native_anchor', 'artifact_repeating_page_furniture', 'normalize_annotation_tab_order', 'repair_native_reading_order', 'repair_annotation_alt_text'],
