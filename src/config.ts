...
export const REMEDIATION_TOOL_STAGE_ORDER: Record<string, number> = {
  ...
  finalize_substituted_font_conformance: 2,
  wrap_singleton_orphan_mcid:          2,
  remap_orphan_mcids_as_artifacts:     2,
  repair_annotation_alt_text:          2,
  artifact_repeating_page_furniture:   3,
  ...
  repair_degenerate_native_reading_order_shell: 4,
  create_structure_from_degenerate_native_anchor: 2,
  create_heading_from_visible_text_anchor: 2,
  create_heading_from_tagged_visible_anchor: 2,
  synthesize_ocr_page_shell_reading_order_structure: 8,
  ...
  canonicalize_figure_alt_ownership:   6,
...
export const REMEDIATION_CRITERION_TOOL_MAP: Record<string, readonly string[]> = {
  ...
  text_extractability:  ['synthesize_basic_structure_from_layout', 'bootstrap_struct_tree', 'substitute_legacy_fonts_in_place', 'finalize_substituted_font_conformance', 'ocr_scanned_pdf', 'tag_native_text_blocks', 'tag_ocr_text_blocks', 'mark_untagged_content_as_artifact'],
  reading_order:        ['synthesize_basic_structure_from_layout', 'create_structure_from_degenerate_native_anchor', 'synthesize_ocr_page_shell_reading_order_structure', 'repair_degenerate_native_reading_order_shell', 'artifact_repeating_page_furniture', 'normalize_annotation_tab_order', 'repair_native_reading_order', 'repair_annotation_alt_text'],
