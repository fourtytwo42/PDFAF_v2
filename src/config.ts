...
export const REMEDIATION_TOOL_STAGE_ORDER: Record<string, number> = {
  ...
  repair_top_level_parent_links:       7,
  repair_parent_tree_mcid_references:  7,
  ...
  bridge_native_title_text_owner: 2,
...
export const REMEDIATION_CRITERION_TOOL_MAP: Record<string, readonly string[]> = {
  ...
  link_quality:         ['set_link_annotation_contents', 'repair_native_link_structure', 'tag_unowned_annotations', 'repair_parent_tree_mcid_references'],
  bookmarks:            ['replace_bookmarks_from_headings', 'add_page_outline_bookmarks'],
  text_extractability:  ['synthesize_basic_structure_from_layout', 'bootstrap_struct_tree', 'substitute_legacy_fonts_in_place', 'finalize_substituted_font_conformance', 'ocr_scanned_pdf', 'tag_native_text_blocks', 'tag_ocr_text_blocks', 'recover_ocr_text_ownership', 'mark_untagged_content_as_artifact'],
