...
export const REMEDIATION_CRITERION_TOOL_MAP: Record<string, readonly string[]> = {
  ...
  heading_structure:    ['synthesize_basic_structure_from_layout', 'create_heading_from_visible_text_anchor', 'create_heading_from_candidate', 'normalize_heading_hierarchy', 'artifact_repeating_page_furniture'],
