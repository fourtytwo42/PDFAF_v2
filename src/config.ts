...
export const REMEDIATION_CRITERION_TOOL_MAP: Record<string, readonly string[]> = {
  ...
  pdf_ua_compliance:    ['set_pdfua_identification', 'synthesize_basic_structure_from_layout', 'bootstrap_struct_tree', 'repair_structure_conformance', 'repair_list_li_wrong_parent', 'wrap_singleton_orphan_mcid', 'remap_orphan_mcids_as_artifacts', 'tag_unowned_annotations', 'repair_annotation_alt_text', 'tag_native_text_blocks', 'tag_ocr_text_blocks', 'mark_untagged_content_as_artifact', 'artifact_repeating_page_furniture'],
  alt_text:             ['canonicalize_figure_alt_ownership', 'set_figure_alt_text', 'mark_figure_decorative', 'repair_alt_text_structure', 'repair_annotation_alt_text', 'retag_as_figure'],
  heading_structure:    ['synthesize_basic_structure_from_layout', 'normalize_heading_hierarchy', 'artifact_repeating_page_furniture'],
  ...
  text_extractability:  ['synthesize_basic_structure_from_layout', 'bootstrap_struct_tree', 'ocr_scanned_pdf', 'tag_native_text_blocks', 'tag_ocr_text_blocks', 'mark_untagged_content_as_artifact'],
