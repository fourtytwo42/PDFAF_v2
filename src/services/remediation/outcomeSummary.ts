...
const FAMILY_TOOLS: Record<StructuralRepairFamily, readonly string[]> = {
  ...
  tables: ['repair_native_table_headers', 'set_table_header_cells'],
  annotations: ['tag_unowned_annotations', 'normalize_annotation_tab_order', 'repair_native_link_structure'],
  tagged_content: ['synthesize_basic_structure_from_layout', 'artifact_repeating_page_furniture', 'wrap_singleton_orphan_mcid', 'remap_orphan_mcids_as_artifacts'],
  headings: ['synthesize_basic_structure_from_layout', 'artifact_repeating_page_furniture', 'normalize_heading_hierarchy'],
};
