...
const FAMILY_TOOLS: Record<StructuralRepairFamily, readonly string[]> = {
  ...
  headings: ['synthesize_basic_structure_from_layout', 'artifact_repeating_page_furniture', 'create_heading_from_visible_text_anchor', 'create_heading_from_candidate', 'normalize_heading_hierarchy', 'repair_structure_conformance'],
};
